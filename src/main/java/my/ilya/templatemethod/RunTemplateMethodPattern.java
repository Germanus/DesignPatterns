...
public class RunTemplateMethodPattern {
    public static void main(String[] arguments) {
        ...
        System.out.println();
        Task primaryTask =
                new Task("Put a JVM on the moon", "Lunar mission as part of the JavaSpace program ;)", 240.0, 100.0);
        ...
        Deliverable deliverableOne =
                new Deliverable("Lunar landing module",
                        "Ask the local garage if they can make a few minor modifications to one of their cars", 2800,
                        40.0, 35.0);
